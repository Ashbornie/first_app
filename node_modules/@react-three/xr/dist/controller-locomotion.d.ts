...
import { type ControllerLocomotionRotationOptions, type ControllerLocomotionTranslationOptions } from '@pmndrs/xr/internals';
/**
 ...
 */
export declare function useControllerLocomotion(target: RefObject<Object3D> | ((velocity: Vector3, rotationVelocityY: number, deltaTime: number, state: RootState, frame?: XRFrame) => void), translationOptions?: ControllerLocomotionTranslationOptions, rotationOptions?: ControllerLocomotionRotationOptions, translationControllerHand?: Exclude<XRHandedness, 'none'>): void;
