 ...
 */
export declare function createControllerLocomotionUpdate(): <T extends Array<any>>(target: Object3D | undefined | null | ((velocity: Vector3, rotationVelocityY: number, ...params: T) => void), store: XRStore<any>, camera: Camera, delta: number, translationOptions?: ControllerLocomotionTranslationOptions, rotationOptions?: ControllerLocomotionRotationOptions, translationControllerHand?: Exclude<XRHandedness, "none">, ...params: T) => void;
